 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre utilisateur avec cet adresse mail existe deja"
 * )
 */
class User implements UserInterface 
{
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Verifier votre mot de passe")
     */
    public $passwordConfirm;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=20, minMessage="Veuillez mettre l'introduction plus de 50 caracteres")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Veuillez mettre l'introduction plus de 100 caracteres")
     */
    private $description;
